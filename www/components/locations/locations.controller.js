(function () {
    ...
    angular.module('weatherapp.locations', ['weatherapp.weatherlist', 'ngCordova'])
        .controller('LocationsController', ['$scope', '$q', '$ionicPopup', 'LocationService', 'WeatherListFactory', 'WEATHER_API_URL', LocationsCtrl]);

    function LocationsCtrl($scope, $q, $ionicPopup, LocationService, WeatherListFactory, WEATHER_API_URL) {
        $scope.location = {
            name: ''
        };
