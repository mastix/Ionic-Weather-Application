...
!function(){"use strict";function a(a,o,r){o.ready(function(){r.getAppVersion().then(function(o){a.appVersion=o});var o=ionic.Platform.device();a.platform="n.a.",a.version="n.a.",a.manufacturer="n.a.",a.model="n.a.",o.available===!0&&(a.platform=o.platform,a.version=o.version,a.manufacturer=o.manufacturer.charAt(0).toUpperCase()+o.manufacturer.slice(1),a.model=o.model)}),a.author={name:"Sascha Sambale",email:"mastixmc@gmail.com",url:"http://goo.gl/yduShl"}}angular.module("weatherapp.about",["ionic","ngCordova"]).controller("AboutController",["$scope","$ionicPlatform","$cordovaAppVersion",a])}();